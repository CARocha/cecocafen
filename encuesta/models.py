...
class Abono(models.Model):
    ...
    respuesta = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    pulpa = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    estiercol = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    gallinaza = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    composta = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    lombrices = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    bocachi = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    foliar = models.IntegerField(choices=CHOICE_ABONO, default=2, blank=True)
    verde = models.IntegerField('Abo. Verde', choices=CHOICE_ABONO, default=2, blank=True)
    hojas = models.IntegerField('Hojas y rastrajos', choices=CHOICE_ABONO, default=2, blank=True)
    quince = models.IntegerField('15-15-15', choices=CHOICE_ABONO, default=2, blank=True)
    veinte = models.IntegerField('20-20-20', choices=CHOICE_ABONO, default=2, blank=True)
    seis = models.IntegerField('18-6-12-4', choices=CHOICE_ABONO, default=2, blank=True)
    urea = models.IntegerField('Urea-Nitrato', choices=CHOICE_ABONO, default=2, blank=True)
...
class Ahorro(models.Model):
    ...
    object_id = models.IntegerField(db_index=True)
    content_object = generic.GenericForeignKey()
    tiene_efectivo = models.IntegerField('Tiene ahorro en efectivo', choices=CHOICE_AHORRO, default=2, blank=True)
    tiene_joya = models.IntegerField('Tiene ahorro en joyeria', choices=CHOICE_AHORRO, default=2, blank=True)
    ...
    posee_ahorro = models.IntegerField('Posee una cuenta de ahorro', choices=CHOICE_AHORRO, default=2, blank=True)
    interes_ahorro = models.IntegerField('¿Si no tiene ahorro, está interesado en ahorrar en una cuenta de ahorro', choices=CHOICE_AHORRO, default=2, blank=True)
